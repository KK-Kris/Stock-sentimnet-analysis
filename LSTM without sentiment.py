...
stockdatawithsentiment = pd.read_csv('stock_no_sentiment_data.csv', index_col='date')
...
# 反归一化
stockdatawithsentiment = pd.read_csv('stock_no_sentiment_data.csv')
...
# plt.ylabel('Close')
plt.savefig("picture/LSTM无1.png", dpi=500, bbox_inches = 'tight')  #  解决图片不清晰，不完整的问题
